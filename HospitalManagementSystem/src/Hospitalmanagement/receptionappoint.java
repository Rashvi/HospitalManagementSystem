 ...
 * @author Asus
 */
public class receptionappoint extends javax.swing.JFrame {
    ...
    String PatientId;
    String patientName;
    public receptionappoint(String PatientId,String patientName) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(tfRoom);
        tfRoom.setBounds(230, 240, 170, 40);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       // String pGender = (String) cb1.getSelectedItem();
        if( PName.equals("") || Pid.equals("") || doctor.equals("") || room.equals("") || dob.equals("")){
 ...
 //      Date date1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(receptionappoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
