 ...
 * @author Asus
 */
public class searchprescription extends javax.swing.JFrame {
 ...
 //      Date date1;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ...
     new   prescriptionTable(PID).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchprescription.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
